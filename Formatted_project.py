...
loss = random.choice(losing_statements)
...
def ring_bell_before_cave():
    ...
    print_pause("You are about to ring the bell")
    print_pause(f"The door opens and out steps a {v}")
    print_pause(f"Opps! This is the {v}'s house!")
    print_pause(f"The {v} sees you!")
    print_pause("You are in trouble now!")
    print_pause("You feel not all set for that, as having an old magic rod.")
...
def cast_a_spell_after_cave():
    ...
    print_pause("The rod shines in your hand.")
...
def beginning():
    ...
    print_pause("You find yourself in an open area.")
    print_pause(f"full of grass and {c} flowers.")
...
while True:
    ...
    # p_again_choice list to validate the play_again input
    beginning()
    c1 = input("Do you want to ring bell (1) or enter cave (2)? ")
    # User first choice
    ...
    if c1 == "1":
        ...
        if c2_1 == "1":
            ...
            print_pause(loss)
            # The user lost
            p_again = input("Do you want to play again? ").lower()
            # Asking the user if he wants to play again
            while p_again not in play_agian_choice:
                # p_again validation
                print_pause("Invalid input")
                p_again = input("Do you want to play again? ").lower()
                if p_again in play_agian_choice:
                    break
            if p_again != "y":
                break
                # Break statement to exit the game

        elif c2_1 == "2":
            run()
            print(f"The score now is {update_score(5)}")
            c3_1 = input("Do you want to ring bell (1) or enter cave (2)? ")
            ...
            if c3_1 == "1":
                ...
                enter_cave()
                print(f"The score now is {update_score(5)}")
                c4_1 = input("Do you want to ring bell (1) or enter cave (2)?")
                # User fourth choice
                while c4_1 not in valid_inputs:
                    # The choice validation
                    print_pause("Invalid input")
                    c4_1 = input("Do you want to 1.ring bell or 2.enter cave?")
        ...
        enter_cave()
        print(f"The score now is {update_score(5)}")
        c2_2 = input("Do you want to ring bell (1) or enter cave (2)? ")
        ...
        if c2_2 == "1":
            ...
            print(f"The score now is {update_score(5)}")
            c3_2 = input("Do you want to 1.cast a spell or 2.run? ")
            ...
            if c3_2 == "1":
                ...
                run()
                print(f"The score now is {update_score(-5)}")
                c4_2 = input("Do you want to 1.ring bell or 2.enter cave")
